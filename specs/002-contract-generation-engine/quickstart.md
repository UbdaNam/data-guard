...
1. Execute generator orchestration from `contracts/generator.py` (for example, `python contracts/generator.py --datasets week3.extractions week5.events`).
...
- `generated_contracts/week3_extractions.metadata.json`
- `generated_contracts/week5_events.metadata.json`
- `validation_reports/readiness_index.json`
